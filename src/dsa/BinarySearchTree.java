...
public class BinarySearchTree {
    ...
    Node5 insert(Node5 root, int data) {
        if (root == null) {
            return new Node5(data); // Empty tree, create new node
        }
        if (data <= root.data) {
    ...
    boolean search(Node5 root, int searchData) {
        if (root == null) {
    ...
    Node5 delete(Node5 root, int data) {
        if (root == null) {
        ...
        if (data < root.data) {
            ...
            // Case 3: Two children
                ...
                Node5 temp = findMin(root.right); // Find inorder successor
    ...
    public static void main(String[] args) {
        ...
        Node5 root = null; // Creating an empty tree
